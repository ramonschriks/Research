...
Curated insights extracted from research and daily sessions.

## Purpose

Distilled learnings from:
- Deep research documents (research/)
- Daily sessions and experiments
...
| conversational-ai-profile-architecture.md | 2026-01-28 | Neo4j vector + ES BM25 for profile + messages |
...
Add new learnings when:
- Completing a research document
- Learning from experiments
- Making mistakes worth remembering
